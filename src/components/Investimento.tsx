        ...
        <div className="mt-[clamp(38px,4.4vw,64px)]">
          <ul className="grid gap-[3px] sm:grid-cols-2 lg:grid-cols-6">
            {investimento.faixas.map((f, i) => {
              ...
              const altura = 46 + (f.preco / MAIOR) * 54;
              return (
                <Revelar key={f.rotulo} como="li" atraso={i * 60}>
                  ...
                  >
                    <div
                      className="mb-4 max-h-[34px] w-full rounded-[6px] transition-[height] duration-500 lg:max-h-none"
                      style={{
                        height: altura,
                        background: dentroDaFaixa ? 'linear-gradient(180deg,#8E82FF,#00C2A8)' : 'rgb(11 13 30 / 0.1)',
                      }}
                      aria-hidden="true"
                    />
